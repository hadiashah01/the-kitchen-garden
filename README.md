...
```bash
git clone https://github.com/hadiashah01/the-kitchen-garden.git
```

Open the project folder and launch `index.html` in your preferred browser. No installation or build process is required.
